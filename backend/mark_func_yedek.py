...
#             if first_part_of_signal=="Strong Sell":
#                 try:
#                     print("sell ",record_list[6],record_list[7],"0",record_list[4],raw_open_price,1,"SELL",0,0,0)
#                     buysellLimit(record_list[6],record_list[7],"0",record_list[4],raw_open_price,1,"SELL",0,0,0)
#                 except Exception as e:
...
#                     #
#                     print("buy ",record_list[6],record_list[7],"0",record_list[4],raw_open_price,10,"BUY",0,0,0)
#                     buysellLimit(record_list[6],record_list[7],"0",record_list[4],raw_open_price,10,"BUY",0,0,0)
#                 except Exception as e:
...
#                 #clickCROSS = wait.until(EC.element_to_be_clickable((By.XPATH,"//div[text()='Cross']")))#/html/body/div[9]/div/div[2]/div/div[2]/div[1]/div/div/div[2]/div[1]/div[1]/div[1]
#                 clickCROSS.click()
...
#                 #click_limit = wait.until(EC.element_to_be_clickable((By.XPATH,"//div[text()='Limit']")))#//*[@id="swap-layout-desktop"]/div[3]/div[2]/div[1]/div[2]/div[1]/div[1]
#                 click_limit.click()
#                 time.sleep(1)
#             except Exception as e:
...
#                 QTY.send_keys(Keys.BACKSPACE)
#                 time.sleep(0.1)
#                 print("qty writeded",number_as_float)
#                 # 6. Belirlenen değeri yaz
...
#             try:
#                 # open_browser.retrun_list=liste
#                 market_reaction()
...
#     except ValueError:
#         # This specific error occurs if 'pair' is not in 'pair_list'
#         log.warning("Pair '%s' not found in the list.", pair)
        
#     except Exception as e:
#         # General error handling for other issues
#         log.warning("Switching tab function error: %s", e)
